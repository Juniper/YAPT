...
AMQP_MESSAGE_TYPE_REST_ASSET_GET = 'rest_asset_get'
...
CONFIG_SOURCE_LOOKUP_TYPE_DEVICE = 'device'
CONFIG_SOURCE_LOOKUP_TYPE_DEVICE_FILE = 'device_file'
CONFIG_SOURCE_LOOKUP_TYPE_GROUP = 'group'
CONFIG_SOURCE_LOOKUP_TYPE_GROUP_FILE = 'group_file'
CONFIG_SOURCE_LOOKUP_TYPE_TEMPLATE = 'template'
CONFIG_SOURCE_LOOKUP_TYPE_TEMPLATE_FILE = 'template_file'
CONFIG_SOURCE_LOOKUP_TYPE_TEMPLATE_BOOTSTRAP = 'template_bootstrap'
