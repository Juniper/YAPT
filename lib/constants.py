...
AMQP_MESSAGE_TYPE_REST_DEV_GET_ALL = 'rest_device_get_all'
AMQP_MESSAGE_TYPE_REST_DEV_GET_BY_SN = 'rest_device_get_by_sn'
...
CONFIG_SOURCE_LOOKUP_TYPE_GET_DEVICE = 'get_device_data'
CONFIG_SOURCE_LOOKUP_TYPE_GET_DEVICE_FILE = 'get_device_file'
