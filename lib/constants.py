...
AMQP_PROCESSOR_SERVICE = 'serviceprocessor'

# AMQP message constants
AMQP_MESSAGE_TYPE_DEVICE_ADD = 'device_add'
AMQP_MESSAGE_TYPE_DEVICE_UPDATE = 'device_update'
AMQP_MESSAGE_TYPE_DEVICE_DELETE = 'device_delete'
AMQP_MESSAGE_TYPE_DEVICE_VERIFY = 'device_verify'
AMQP_MESSAGE_TYPE_DEVICE_UPDATE_TASK_STATE = 'device_updateTaskState'
AMQP_MESSAGE_TYPE_REST_SITE_ADD = 'rest_site_add'
AMQP_MESSAGE_TYPE_REST_SITE_DEL = 'rest_site_del'
AMQP_MESSAGE_TYPE_REST_SITE_GET_ALL = 'rest_site_get_all'
AMQP_MESSAGE_TYPE_REST_SITE_GET_BY_ID = 'rest_site_get_by_id'
AMQP_MESSAGE_TYPE_REST_ASSET_ADD = 'rest_asset_add'
AMQP_MESSAGE_TYPE_REST_ASSET_GET_BY_SERIAL = 'rest_asset_get_by_serial'
AMQP_MESSAGE_TYPE_REST_ASSET_GET_BY_SITE = 'rest_asset_get_by_site'
AMQP_MESSAGE_TYPE_REST_ASSET_UPDATE = 'rest_asset_update'
AMQP_MESSAGE_TYPE_REST_DEVICE_GET_ALL = 'rest_device_get_all'
AMQP_MESSAGE_TYPE_REST_DEVICE_GET_BY_SN = 'rest_device_get_by_sn'
AMQP_MESSAGE_TYPE_REST_DEVICE_CFG_ADD = 'rest_device_cfg_add'
AMQP_MESSAGE_TYPE_REST_DEVICE_GET_CFG_BY_SERIAL = 'rest_device_get_cfg_by_name'
AMQP_MESSAGE_TYPE_REST_DEVICE_GET_CFG_ALL = 'rest_device_get_cfg_all'
AMQP_MESSAGE_TYPE_REST_DEVICE_CFG_UPDATE = 'rest_device_cfg_update'
AMQP_MESSAGE_TYPE_REST_DEVICE_CFG_DEL = 'rest_device_cfg_del'
AMQP_MESSAGE_TYPE_REST_GROUP_ADD = 'rest_group_add'
AMQP_MESSAGE_TYPE_REST_GROUP_GET_BY_NAME = 'rest_group_get_by_name'
AMQP_MESSAGE_TYPE_REST_GROUP_GET_ALL = 'rest_group_get_all'
AMQP_MESSAGE_TYPE_REST_GROUP_UPDATE = 'rest_group_update'
AMQP_MESSAGE_TYPE_REST_GROUP_DEL = 'rest_group_del'
AMQP_MESSAGE_TYPE_REST_TEMPLATE_ADD = 'rest_template_add'
AMQP_MESSAGE_TYPE_REST_TEMPLATE_GET_BY_NAME = 'rest_template_get_by_name'
AMQP_MESSAGE_TYPE_REST_TEMPLATE_GET_ALL = 'rest_template_get_all'
AMQP_MESSAGE_TYPE_REST_TEMPLATE_UPDATE = 'rest_template_update'
AMQP_MESSAGE_TYPE_REST_TEMPLATE_DEL = 'rest_template_del'
AMQP_MESSAGE_TYPE_REST_IMAGE_ADD = 'rest_image_add'
AMQP_MESSAGE_TYPE_REST_IMAGE_GET_BY_NAME = 'rest_image_get_by_name'
AMQP_MESSAGE_TYPE_REST_IMAGE_GET_ALL = 'rest_image_get_all'
AMQP_MESSAGE_TYPE_REST_IMAGE_UPDATE = 'rest_image_update'
AMQP_MESSAGE_TYPE_REST_IMAGE_DEL = 'rest_image_del'
AMQP_MESSAGE_TYPE_REST_SERVICE_GET_BY_NAME = 'rest_service_get_by_name'
AMQP_MESSAGE_TYPE_REST_SERVICE_GET_ALL = 'rest_service_get_all'
AMQP_MESSAGE_TYPE_REST_SERVICE_UPDATE = 'rest_service_update'
AMQP_MESSAGE_TYPE_REST_SERVICE_START = 'rest_service_start'
AMQP_MESSAGE_TYPE_REST_SERVICE_STOP = 'rest_service_stop'
AMQP_MESSAGE_TYPE_REST_SERVICE_RESTART = 'rest_service_restart'
...
# Config source plugins lookup type
CONFIG_SOURCE_LOOKUP_TYPE_GET_DEVICE_CFG = 'get_device_data'
CONFIG_SOURCE_LOOKUP_TYPE_GET_DEVICE_CFG_FILE = 'get_device_file'
CONFIG_SOURCE_LOOKUP_TYPE_ADD_DEVICE_CFG = 'add_device_data'
CONFIG_SOURCE_LOOKUP_TYPE_DEL_DEVICE_CFG = 'del_device_data'
CONFIG_SOURCE_LOOKUP_TYPE_GET_GROUP = 'get_group_data'
CONFIG_SOURCE_LOOKUP_TYPE_GET_GROUP_FILE = 'get_group_file'
CONFIG_SOURCE_LOOKUP_TYPE_ADD_GROUP = 'add_group_data'
CONFIG_SOURCE_LOOKUP_TYPE_DEL_GROUP = 'del_group_data'
CONFIG_SOURCE_LOOKUP_TYPE_GET_TEMPLATE = 'get_template_data'
CONFIG_SOURCE_LOOKUP_TYPE_GET_TEMPLATE_FILE = 'get_template_file'
CONFIG_SOURCE_LOOKUP_TYPE_ADD_TEMPLATE = 'add_template_data'
CONFIG_SOURCE_LOOKUP_TYPE_DEL_TEMPLATE = 'del_template_data'
CONFIG_SOURCE_LOOKUP_TYPE_TEMPLATE_BOOTSTRAP = 'get_template_bootstrap_data'
